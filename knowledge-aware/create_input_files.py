...
class InputConstructor:
    def __init__(
        ...
        :param knowledge_path: path to the pickle file with the knowledge context for each image 
            - a dict of the format {url: df with the knowledge context}
        ...
        self.knowledge_context_size = 50
        #
    ...
    def get_data_for_image(self, img, word_map):
        ...
        (
            ...
            random_value_range = [(0.0, 10.0), (-179.0, 179.0), (0.0, 0.1), (0, 500)],
            context_size=self.entity_context_size,
            unk_dummy="<unk_ent>"
        )
        # Process the knowledge context for the image.
        knowledge_context_for_image = self.knowledge_contexts[image_url]
        (
            facts,
            fact_names,
        ) = ut.prepare_context(
            ...
            random_value_range = [(300, 300), (0, 0)],
