...
zero_out_epochs_since_improvement = False # if starting from a checkpoint, start from epoch 0 or continue from the last epoch recorded
...
def train(
    ...
    for i, (
        ...
        scores, captions_sorted, decode_lengths = decoder(
            captions, imgs, caption_masks, caption_lengths, entity_features
        )
        #
